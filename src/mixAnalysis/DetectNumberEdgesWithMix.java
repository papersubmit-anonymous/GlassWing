...
public class DetectNumberEdgesWithMix {
    static String outFile = "/home/syc/outs/DetectNumberEdgesWithMix.csv";
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, String> entry : apkFileMap.entrySet()) {
            ...
            setupApplication.addPreprocessor(new MixPreAnalysisHandler(setupApplication));
            ...
            try {
                ...
                config.setDataFlowTimeout(6000000);
                config.getCallbackConfig().setCallbackAnalysisTimeout(6000000);
                config.getPathConfiguration().setPathReconstructionTimeout(6000000);
