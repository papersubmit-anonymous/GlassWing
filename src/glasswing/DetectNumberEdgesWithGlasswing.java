...
public class DetectNumberEdgesWithGlasswing {
    static String outFile = "/home/syc/outs/DetectNumberEdgesWithGlasswing.csv";

    public static void main(String[] args) {
        System.setProperty("java.vm.args", "-Xmx60G");
        ...
        for (Map.Entry<String, String> entry : apkFileMap.entrySet()) {
            ...
            setupApplication.addPreprocessor(new testPre(setupApplication, entry.getKey()));
            ...
            try {
                ...
                dot.plot("/home/syc/callgraph.dot");
                data[1] = "true";
