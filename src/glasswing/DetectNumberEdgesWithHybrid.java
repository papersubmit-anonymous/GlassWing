...
public class DetectNumberEdgesWithHybrid {
    static String outFile = "/home/syc/outs/DetectNumberEdgesWithHybrid.csv";

    public static void main(String[] args) {
        //System.setProperty("java.vm.args", "-Xmx20G"); // 20G in MB
        String appFolder = "/home/syc/CrossAPP";
        ...
        for (Map.Entry<String, String> entry : apkFileMap.entrySet()) {
            ...
            //setupApplication.addPreprocessor(new testPre(setupApplication)); // Add Glasswing preprocessor
            ...
            try {
                ...
                config.setDataFlowTimeout(600000000);
                config.getCallbackConfig().setCallbackAnalysisTimeout(600000000);
                config.getPathConfiguration().setPathReconstructionTimeout(600000000);
